...
const Login = (props) => {
  ...
  const PostLogIn = async (e) => {
    ...
    if(res.status === 200) cookies.set("jwtoken", data.token, {path: "/"});
  ...
  return (
    <div>
      <Navbar />
      <section className="bg-[#9a9ab3] min-h-screen flex items-center justify-center">
        <div
          className="w-full p-6 bg-gray-700 rounded-lg shadow dark:border md:mt-0 sm:max-w-md dark:bg-gray-800 dark:border-gray-700 sm:p-8 bg-[#9a9ab3]"
          style={{ margin: "0 10px" }}
        >
